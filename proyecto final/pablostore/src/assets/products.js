...
export const products = [
  {
    ...
    precio: 25.99,
    descripcion: "Vinilo clásico de punk rock lanzado en 2004. Incluye éxitos como 'Boulevard of Broken Dreams' y 'Holiday'.",
    img: "https://i.scdn.co/image/ab67616d0000b27308a1b1e0674086d3f1995e1b",
    categoria: "Rock"
  },
  {
    id: 2,
    nombre: "Pink Floyd – The Dark Side of the Moon",
    precio: 29.99,
  ...
  },
  {
    ...
    precio: 27.50,
    descripcion: "El segundo álbum de Nirvana que revolucionó el grunge. Contiene 'Smells Like Teen Spirit' y otros clásicos.",
    img: "https://imagenes.elpais.com/resizer/v2/J4MZMQKLQYOZ7RQXT3P5TPN7QM.jpg?auth=39f04afc389740f724fbe5266c605ad15646844cbfbe19c04fbbda0566e0f4af&width=980&height=980&focal=196%2C103",
    categoria: "Rock"
  },
  {
    id: 4,
    ...
    precio: 35.00,
    descripcion: "Lanzado en 1969, es uno de los álbumes más emblemáticos de The Beatles con temas como 'Come Together'.",
  ...
  },
  {
    ...
    precio: 24.75,
    descripcion: "Disco moderno de indie rock británico. Incluye 'Do I Wanna Know?' y 'R U Mine?'.",
    img: "https://www.labananera.com/cdn/shop/products/arctic-monkeys-am-cd-fin.png?v=1611385274",
    categoria: "Rock"
  },
  {
    id: 6,
    nombre: "David Bowie – The Rise and Fall of Ziggy Stardust",
    precio: 26.80,
    descripcion: "Obra maestra de Bowie de 1972 con una mezcla de glam rock y ciencia ficción musical.",
    img: "https://upload.wikimedia.org/wikipedia/en/thumb/0/01/ZiggyStardust.jpg/250px-ZiggyStardust.jpg",
    categoria: "Rock"
  },
  {
    id: 7,
    nombre: "C Tangana – El Madrileño",
    precio: 26.80,
    descripcion: "El Madrileño es un álbum del artista español C. Tangana, lanzado el 26 de febrero de 2021. Este disco marcó un cambio notable en su estilo musical, fusionando géneros tradicionales como el flamenco, la rumba y la copla con sonidos modernos como el trap, el reguetón y la música urbana",
    img: "https://i.scdn.co/image/ab67616d0000b273a408c78e231f716383a58eb3",
    categoria: "Urbano"
  },
  {
    id: 8,
    ...
    precio: 22.50,
    descripcion: "La Velocidad de la Luz es el tercer álbum de estudio de la banda chilena Los Bunkers, lanzado en 2005. Este disco consolidó su estilo característico, combinando rock alternativo con letras poéticas y melancólicas.",
    img: "https://i.scdn.co/image/ab67616d0000b273a5d2418a94c6d9ea86ed906a",
    categoria: "Rock"
  },
  {
    id: 9,
    nombre: "Soda Stereo – Canción Animal",
    precio: 28.00,
    descripcion: "Canción Animal es el quinto álbum de estudio de la banda argentina Soda Stereo, lanzado en 1990. Este disco es considerado uno de los más importantes del rock en español y contiene clásicos como 'De Música Ligera' y 'En el borde'.",
    img: "https://i.scdn.co/image/ab67616d0000b273c451ed28353639e79b4d97d9",
    categoria: "Rock"
  },
  {
    id: 10,
    nombre: "Los Fabulosos Cadillacs – El León",
    precio: 23.50,
    descripcion: "El León es el álbum debut de la banda argentina Los Fabulosos Cadillacs, lanzado en 1992. Este disco mezcla rock, ska y ritmos latinos, y contiene éxitos como 'Matador' y 'El León'.",
    img: "https://upload.wikimedia.org/wikipedia/en/4/4f/LFC-El_Leon.jpg",
    categoria: "Latino"
  },
  {
    id: 11,
    nombre: "Calle 13 – Los de Atrás Vienen Conmigo",
    precio: 24.00,
